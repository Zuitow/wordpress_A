...
function medical_hospital_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting('medical_hospital_blog_post_alignment',array(
        'default' => 'left',
        'sanitize_callback' => 'medical_hospital_sanitize_choices'
    ));
	$wp_customize->add_control('medical_hospital_blog_post_alignment', array(
        'type' => 'select',
        'label' => __( 'Blog Post Alignment', 'medical-hospital' ),
        'section' => 'medical_hospital_theme_layout',
        'choices' => array(
            'left' => __('Left Align','medical-hospital'),
            'right' => __('Right Align','medical-hospital'),
            'center' => __('Center Align','medical-hospital')
        ),
    ));
    ...
    $wp_customize->add_setting('medical_hospital_postdate_icon',array(
		'default'	=> 'fas fa-calendar-alt',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new medical_hospital_Icon_Selector(
        $wp_customize,'medical_hospital_postdate_icon',array(
		'label'	=> __('Add Post Date Icon','medical-hospital'),
		'transport' => 'refresh',
		'section'	=> 'medical_hospital_theme_layout',
		'setting'	=> 'medical_hospital_postdate_icon',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('medical_hospital_postauthor_icon',array(
		'default'	=> 'fa fa-user',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new medical_hospital_Icon_Selector(
        $wp_customize,'medical_hospital_postauthor_icon',array(
		'label'	=> __('Post Author Icon','medical-hospital'),
		'transport' => 'refresh',
		'section'	=> 'medical_hospital_theme_layout',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('medical_hospital_postcomment_icon',array(
		'default'	=> 'fas fa-comments',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new medical_hospital_Icon_Selector(
        $wp_customize,'medical_hospital_postcomment_icon',array(
		'label'	=> __('Post Comments Icon','medical-hospital'),
		'transport' => 'refresh',
		'section'	=> 'medical_hospital_theme_layout',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('medical_hospital_posttime_icon',array(
		'default'	=> 'fas fa-clock',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new medical_hospital_Icon_Selector(
        $wp_customize,'medical_hospital_posttime_icon',array(
		'label'	=> __('Post Time Icon','medical-hospital'),
		'transport' => 'refresh',
		'section'	=> 'medical_hospital_theme_layout',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting( 'medical_hospital_single_post_img_border_radius', array(
		'default'=> 0,
		'sanitize_callback'	=> 'medical_hospital_sanitize_float',
	) );
	$wp_customize->add_control( 'medical_hospital_single_post_img_border_radius', array(
		'label'       => esc_html__( 'Single Post Image Border Radius','medical-hospital' ),
		'section'     => 'medical_hospital_single_post_settings',
		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting( 'medical_hospital_single_post_img_box_shadow',array(
		'default' => 0,
		'sanitize_callback'    => 'medical_hospital_sanitize_float',
	));
	$wp_customize->add_control('medical_hospital_single_post_img_box_shadow',array(
		'label' => esc_html__( 'Single Post Image Shadow','medical-hospital' ),
		'section' => 'medical_hospital_single_post_settings',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
    ...
    $wp_customize->add_setting( 'medical_hospital_related_post_excerpt_number',array(
		'default' => 20,
		'sanitize_callback' => 'medical_hospital_sanitize_float'
	));

	$wp_customize->add_control('medical_hospital_related_post_excerpt_number',	array(
		'label' => esc_html__( 'Related Posts Content Limit','medical-hospital' ),
		'section' => 'medical_hospital_single_post_settings',
		'type'    => 'number',
	 	'settings' => 'medical_hospital_related_post_excerpt_number',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
			'step' => 1,
	...
	$wp_customize->add_setting( 'medical_hospital_single_page_breadcrumb',array(
		'default' => true,
      	'sanitize_callback'	=> 'medical_hospital_sanitize_checkbox'
    ) );
    $wp_customize->add_control('medical_hospital_single_page_breadcrumb',array(
    	'type' => 'checkbox',
        'label' => __( 'Show / Hide Single Page Breadcrumb','medical-hospital' ),
        'section' => 'medical_hospital_advance_options'
    ));
	...
	$wp_customize->add_setting( 'medical_hospital_sidebar_hide_show',array(
      'default' => true,
      'sanitize_callback'	=> 'medical_hospital_sanitize_checkbox'
    ));
    $wp_customize->add_control('medical_hospital_sidebar_hide_show',array(
      'type' => 'checkbox',
      'label' => esc_html__( 'Enable Sidebar','medical-hospital' ),
      'section' => 'medical_hospital_responsive_options'
    ));
    ...
    $wp_customize->add_setting('medical_hospital_shop_page_layout', array(
		'default'           => 'Right Sidebar',
		'sanitize_callback' => 'medical_hospital_sanitize_choices',
	));
	$wp_customize->add_control('medical_hospital_shop_page_layout',array(
		'type'           => 'radio',
		'label'          => __('Shop Page Layout', 'medical-hospital'),
		'section'        => 'medical_hospital_woocommerce',
		'choices'        => array(
			'Left Sidebar'  => __('Left Sidebar', 'medical-hospital'),
			'Right Sidebar' => __('Right Sidebar', 'medical-hospital'),
    ...
    $wp_customize->add_setting('medical_hospital_single_product_page_layout', array(
		'default'           => 'Right Sidebar',
		'sanitize_callback' => 'medical_hospital_sanitize_choices',
	));
	$wp_customize->add_control('medical_hospital_single_product_page_layout',array(
		'type'           => 'radio',
		'label'          => __('Single Product Page Layout', 'medical-hospital'),
		'section'        => 'medical_hospital_woocommerce',
		'choices'        => array(
			'Left Sidebar'  => __('Left Sidebar', 'medical-hospital'),
			'Right Sidebar' => __('Right Sidebar', 'medical-hospital'),
